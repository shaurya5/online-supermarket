...
function OrderSummary() {
  ...
  useEffect(() => {
    ...
    finalProducts.map((finalProduct) => {
      ...
      newProduct.totalPrice =
        ...
        parseInt(newProduct.productDiscountedPrice);
  ...
  return (
    <>
      <DashboardNav />
      <div
        className="row g-3 mt-5 pl-2 mx-4 border border-2 shadow p-2 rounded"
        style={{ width: "60vw" }}
      >
...
function UserForm() {
  return (
    <div className="pl-2 mx-5" style={{ width: "40vw" }}>
      <form
        className="row g-5 mt-5 border border-2 shadow p-3 rounded "
        style={{ width: "35vw" }}
      >
